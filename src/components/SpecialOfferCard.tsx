    ...
    <article className="group flex flex-col overflow-hidden rounded-2xl bg-paper shadow-[0_10px_30px_rgba(28,36,48,0.07)] transition-all hover:-translate-y-0.5 hover:shadow-[0_18px_40px_rgba(28,36,48,0.12)]">
      ...
      <div className="flex flex-1 flex-col gap-3 p-6">
        ...
        <div className="mt-auto flex gap-2.5 pt-2">
          ...
          {offer.affiliate_url && (
            <a href={offer.affiliate_url} target="_blank" rel="nofollow sponsored noopener" className="flex min-h-11 flex-1 items-center justify-center rounded-xl bg-gradient-to-b from-brand-soft to-brand-dark px-3 py-2.5 text-center text-sm font-bold text-white shadow-md shadow-brand/25 transition-transform hover:-translate-y-0.5">Claim</a>
          )}
        </div>
      </div>
    </article>
